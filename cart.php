							...
							<table class="cart-table">
								...
								<tbody>
									...
									<tr class="table-body-row">
										...
										<td class="product-quantity"><?php echo $row['pro_qty'];?></td>
										<td class="product-total" ><?php echo $row['total'];?><input type="hidden"  id="tot" value="<?php echo $row['total'];?>"></td>
										<td class="product-edit"><a href="single-product.php?id=<?php echo $row['pro_id']; ?>"><i class="fas fa-edit " style="color:black"></i></td>
								...
								<tfoot>
									<tr>
										...
										<div class="cart-buttons">
											...
											<a href="clearcart.php?id=<?php echo $tes['user_id']; ?>" onclick="return confirm('Are you sure you want to delete all items?');" class="boxed-btn" style="margin-left:358px;">Clear Cart</a>
										</div>
										</td>
									</tr>
								</tfoot>
