...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
			<form class="login100-form validate-form flex-sb flex-w" action="loginaction.php" onsubmit="return myFunction()" method="post">
				...
				<div class="wrap-input100 validate-input m-b-36" data-validate = "Not valid" >
					<input class="input100" type="email" id=textEmail name="em" required>
				...
				<div class="wrap-input100 validate-input m-b-12" data-validate = "Password is required">
					<span class="btn-show-pass">
						<i class="fa fa-eye" onclick="passwordchk()"></i>
					</span>
